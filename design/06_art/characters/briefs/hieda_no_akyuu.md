# Hieda no Akyuu — Production Modeling Brief
## 稗田 阿求

- **Production tier:** B
- **Region / faction:** Human Village / Gensokyo Chronicle
- **Route scope:** Major support
- **Source character contract:** `04_characters/hieda_no_akyuu/skills.md`

## Silhouette lock

short formal hair, flower ornament, kimono block and book/brush

- Primary prop: chronicle / brush
- Separate child/FX layer: page and ink-stamp layer
- Preferred presentation profiles: A, B, C

## Motion lock

- Idle: brush pauses above a page; breath is minimal.
- Talk/gesture: turns the book toward the listener, then withholds one line.
...
observant courtesy, mortality-aware resolve, quiet mischief
...
archive work; village formal; winter writing layer
