# Suika Ibuki — Production Modeling Brief
## 伊吹 萃香

- **Production tier:** B
- **Region / faction:** Oni / frequent Hakurei Shrine guest
- **Route scope:** Support route; fighter expansion
- **Source character contract:** `04_characters/suika_ibuki/skills.md`

## Silhouette lock

oni horns, gourd, chain arcs and compact powerful stance

- Primary prop: gourd / chain
- Separate child/FX layer: mist and density-clone layer
- Preferred presentation profiles: A, C, D

## Motion lock

- Idle: takes a sip without moving the gourd level incorrectly.
- Talk/gesture: chain clink or mist cluster punctuates a teasing line.
...
boisterous perception, loneliness, honest challenge
...
shrine guest; festival coat; mist-body battle
