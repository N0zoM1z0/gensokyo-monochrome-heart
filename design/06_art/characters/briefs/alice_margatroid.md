# Alice Margatroid — Production Modeling Brief
## アリス・マーガトロイド

- **Production tier:** B
- **Region / faction:** Forest of Magic / magician
- **Route scope:** Support route with romance-ready expansion
- **Source character contract:** `04_characters/alice_margatroid/skills.md`

## Silhouette lock

hair ribbon, fitted dress, puppet strings and doll shapes

- Primary prop: grimoire / control cross
- Separate child/FX layer: Shanghai and Hourai doll anchors
- Preferred presentation profiles: A, B, C

## Motion lock

- Idle: fingers tighten one thread while a doll lags one frame.
- Talk/gesture: a doll mirrors or contradicts her restrained hand gesture.
...
precision, guarded pride, private softness
...
work apron; rain cloak; formal dollmaker
