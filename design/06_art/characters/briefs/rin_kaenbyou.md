# Rin Kaenbyou — Production Modeling Brief
## 火焔猫 燐

- **Production tier:** C
- **Region / faction:** Palace of the Earth Spirits / Former Hell
- **Route scope:** Support route
- **Source character contract:** `04_characters/rin_kaenbyou/skills.md`

## Silhouette lock

cat ears, twin braids/tails and wheelbarrow/ghost-fire shapes

- Primary prop: wheelbarrow / corpse cart
- Separate child/FX layer: two tails and spirit flame layer
- Preferred presentation profiles: D

## Motion lock

- Idle: tail flame lifts while hands stay on the cart.
- Talk/gesture: leans on the handle; spirits react to the joke.
...
cheerful morbidity, loyalty, work pride
...
work dress; surface visit; furnace-rescue set
