# Kanako Yasaka — Production Modeling Brief
## 八坂 神奈子

- **Production tier:** B
- **Region / faction:** Moriya Shrine
- **Route scope:** Major support
- **Source character contract:** `04_characters/kanako_yasaka/skills.md`

## Silhouette lock

huge shimenawa ring, broad sleeves and onbashira verticals

- Primary prop: onbashira / sacred rope
- Separate child/FX layer: rope ring and pillar layer
- Preferred presentation profiles: A, B, D

## Motion lock

- Idle: rope tassels settle while she holds a public pose.
- Talk/gesture: one pillar mark or broad sleeve gesture frames the argument.
...
executive confidence, strategic warmth, divine scale
...
shrine work; summit storm coat; festival formal
