# Nazrin — Production Modeling Brief
## ナズーリン

- **Production tier:** C
- **Region / faction:** Myouren Temple circle / Shou's subordinate
- **Route scope:** Support route
- **Source character contract:** `04_characters/nazrin/skills.md`

## Silhouette lock

mouse ears/tail, dowsing rods and pendulum triangle

- Primary prop: dowsing rods / pendulum
- Separate child/FX layer: tail and pendulum layer
- Preferred presentation profiles: A, B

## Motion lock

- Idle: pendulum moves while eyes remain skeptical.
- Talk/gesture: rods cross or point to the actual evidence.
...
pragmatism, appraisal, understated loyalty
...
temple errands; cave search coat; market disguise
