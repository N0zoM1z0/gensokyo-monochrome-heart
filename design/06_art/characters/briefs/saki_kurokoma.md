# Saki Kurokoma — Production Modeling Brief
## 驪駒 早鬼

- **Production tier:** C
- **Region / faction:** Animal Realm / Keiga Family
- **Route scope:** Support rival
- **Source character contract:** `04_characters/saki_kurokoma/skills.md`

## Silhouette lock

horse ears/tail, broad athletic stance and coat/wing speed wedges

- Primary prop: kick arc / reins motif
- Separate child/FX layer: tail and dust layer
- Preferred presentation profiles: A, D

## Motion lock

- Idle: hoof tap and forward shoulder; no dainty bounce.
- Talk/gesture: wide grin, thumb toward the next challenge.
...
straightforward rivalry, speed, respect
...
Keiga patrol; racing scarf; formal faction coat
