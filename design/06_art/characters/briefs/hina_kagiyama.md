# Hina Kagiyama — Production Modeling Brief
## 鍵山 雛

- **Production tier:** C
- **Region / faction:** Youkai Mountain forest / misfortune god
- **Route scope:** Support route
- **Source character contract:** `04_characters/hina_kagiyama/skills.md`

## Silhouette lock

many ribbons, spiral skirt and circular misfortune silhouette

- Primary prop: misfortune amulet
- Separate child/FX layer: ribbon spiral layer
- Preferred presentation profiles: A, D

## Motion lock

- Idle: slow quarter-turn; ribbons lag in alternating directions.
- Talk/gesture: stops the spin for one direct sentence.
...
gentleness, ritual caution, lonely humor
...
forest work; festival purification; storm set
