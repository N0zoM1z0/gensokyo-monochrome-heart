# Yoshika Miyako — Production Modeling Brief
## 宮古 芳香

- **Production tier:** C
- **Region / faction:** Seiga's jiang-shi / mausoleum
- **Route scope:** Minor support; safety-sensitive
- **Source character contract:** `04_characters/yoshika_miyako/skills.md`

## Silhouette lock

jiang-shi cap/talisman, stiff forward arms and heavy hopping feet

- Primary prop: forehead talisman
- Separate child/FX layer: talisman and hunger cue layer
- Preferred presentation profiles: C, D

## Motion lock

- Idle: small rigid sway, then one delayed jaw movement.
- Talk/gesture: simple hand/jaw motion; humor never erases dependence or safety.
...
literal hunger, loyalty, safety-sensitive comedy
...
mausoleum guard; repaired talisman; rain-stiff set
