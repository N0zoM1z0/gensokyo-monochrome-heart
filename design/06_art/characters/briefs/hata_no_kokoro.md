# Hata no Kokoro — Production Modeling Brief
## 秦 こころ

- **Production tier:** B
- **Region / faction:** Menreiki / performance traditions
- **Route scope:** Support route; fighter expansion
- **Source character contract:** `04_characters/hata_no_kokoro/skills.md`

## Silhouette lock

bob hair, broad sleeves and a halo/fan of distinct masks

- Primary prop: selected mask / fan
- Separate child/FX layer: mask wheel companion layer
- Preferred presentation profiles: B, C, D

## Motion lock

- Idle: one mask changes while her face remains neutral.
- Talk/gesture: the chosen mask moves to the foreground and supplies the gesture.
...
literal focus, learned emotion, uncanny comedy
...
stage costume; rehearsal plainwear; festival mask set
