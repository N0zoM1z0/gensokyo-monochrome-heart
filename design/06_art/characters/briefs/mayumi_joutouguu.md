# Mayumi Joutouguu — Production Modeling Brief
## 杖刀偶 磨弓

- **Production tier:** C
- **Region / faction:** Primate Spirit Garden / haniwa army
- **Route scope:** Support route
- **Source character contract:** `04_characters/mayumi_joutouguu/skills.md`

## Silhouette lock

haniwa armor, helmet crest and disciplined sword line

- Primary prop: sword / bow
- Separate child/FX layer: haniwa rank layer
- Preferred presentation profiles: B, D

## Motion lock

- Idle: military cadence and exact equipment check.
- Talk/gesture: salute or tactical point; no casual flailing.
...
loyalty, directness, learning individuality
...
garden patrol; ceremonial armor; damaged haniwa set
