# Chen — Production Modeling Brief
## 橙

- **Production tier:** C
- **Region / faction:** Yakumo household / Youkai Mountain and Mayohiga
- **Route scope:** Support route
- **Source character contract:** `04_characters/chen/skills.md`

## Silhouette lock

cat ears, two tails, short dress and quick low stance

- Primary prop: claw swipe / charm
- Separate child/FX layer: two independent tail layers
- Preferred presentation profiles: A, D

## Motion lock

- Idle: one tail notices first, the second catches up.
- Talk/gesture: leans forward, hands close to chest, tails reveal the real mood.
...
curiosity, loyalty, sudden embarrassment
...
Mayohiga errands; rain hood; festival ribbon
