# Joon Yorigami — Production Modeling Brief
## 依神 女苑

- **Production tier:** C
- **Region / faction:** Pestilence / financial ruin goddess
- **Route scope:** Support antagonist
- **Source character contract:** `04_characters/joon_yorigami/skills.md`

## Silhouette lock

fur collar, fashionable bow, handbag/fan and hip-forward stance

- Primary prop: purse / fan / coins
- Separate child/FX layer: coin sparkle and accessory layer
- Preferred presentation profiles: B, C

## Motion lock

- Idle: coin flips with practiced indifference.
- Talk/gesture: hand on hip, fan snap, then a glance at the cost.
...
swagger, appraisal, flashes of insecurity
...
luxury set; stripped-down penance set; festival fashion
