# Toyosatomimi no Miko — Production Modeling Brief
## 豊聡耳 神子

- **Production tier:** B
- **Region / faction:** Senkai / Taoist leadership
- **Route scope:** Major support; fighter expansion
- **Source character contract:** `04_characters/toyostomimi_no_miko/skills.md`

## Silhouette lock

earmuffs, cape triangle and ritual sword/tablet line

- Primary prop: shaku / sword
- Separate child/FX layer: voice-wave and cape layer
- Preferred presentation profiles: B, C, D

## Motion lock

- Idle: earpieces pulse as multiple voices arrive.
- Talk/gesture: one precise cape opening frames a public declaration.
...
charisma, listening overload, strategic compassion
...
Senkai formal; public audience; battle regalia
