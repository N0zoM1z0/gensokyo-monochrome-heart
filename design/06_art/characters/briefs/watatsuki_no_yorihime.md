# Watatsuki no Yorihime — Production Modeling Brief
## 綿月 依姫

- **Production tier:** B
- **Region / faction:** Lunar Capital / Watatsuki household
- **Route scope:** Late-game support/duel
- **Source character contract:** `04_characters/watatsuki_no_yorihime/skills.md`

## Silhouette lock

lunar military robe, tied hair and disciplined sword silhouette

- Primary prop: sword / divine invocation
- Separate child/FX layer: deity crest and blade layer
- Preferred presentation profiles: B, D

## Motion lock

- Idle: breath and sword hand move in exact cadence.
- Talk/gesture: one formal hand sign precedes any drawn blade.
...
discipline, certainty, respectful severity
...
lunar command; Earth duel; shrine invocation set
