# Clownpiece — Production Modeling Brief
## クラウンピース

- **Production tier:** C
- **Region / faction:** Hell / Hecatia's subordinate
- **Route scope:** Support friendship only
- **Source character contract:** `04_characters/clownpiece/skills.md`

## Silhouette lock

jester cap, star-and-stripe geometry, torch and energetic legs

- Primary prop: torch
- Separate child/FX layer: flame and flag-pattern layer
- Preferred presentation profiles: B, D

## Motion lock

- Idle: flame changes while the body holds a coiled bounce.
- Talk/gesture: torch arcs wide; eyes and cap bells carry the chaos.
...
mischief, bewilderment, dangerous excitement
...
Hell patrol; festival torch; moon-surface dust
