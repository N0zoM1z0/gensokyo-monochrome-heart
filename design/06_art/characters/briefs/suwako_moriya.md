# Suwako Moriya — Production Modeling Brief
## 洩矢 諏訪子

- **Production tier:** C
- **Region / faction:** Moriya Shrine / ancient local deity
- **Route scope:** Support route
- **Source character contract:** `04_characters/suwako_moriya/skills.md`

## Silhouette lock

frog-eye hat, compact crouch and iron ring circles

- Primary prop: iron ring / frog glyph
- Separate child/FX layer: hat-eye and water layer
- Preferred presentation profiles: A, C, D

## Motion lock

- Idle: hat eyes blink separately while she stays low.
- Talk/gesture: crouched hand gesture or one ring rolling into frame.
...
shrine casual; ancient ritual; rainy field set
