# Satori Komeiji — Production Modeling Brief
## 古明地 さとり

- **Production tier:** B
- **Region / faction:** Palace of the Earth Spirits
- **Route scope:** Support route with romance-ready expansion
- **Source character contract:** `04_characters/satori_komeiji/skills.md`

## Silhouette lock

third-eye heart, looping cords and compact indoor posture

- Primary prop: third eye / book
- Separate child/FX layer: eye and cord path layer
- Preferred presentation profiles: B, C, D

## Motion lock

- Idle: third eye blinks before her own eyes react.
- Talk/gesture: cords lean toward the thought she chooses not to expose.
...
measured reading, loneliness, consent-aware restraint
...
palace work; animal-care apron; surface cloak
