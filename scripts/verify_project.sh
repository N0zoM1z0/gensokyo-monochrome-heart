...
run_checked "M16 production visual assets" python3 scripts/build_m16_visual_assets.py --check
run_checked "M16 production audio" python3 scripts/build_m16_audio_assets.py --check
run_checked "M16 production coverage" python3 scripts/validate_m16_production.py
...
run_checked "M18 locale switching soak" env XDG_DATA_HOME="$LOG_DIR/user-data" \
	"$GODOT_BIN" --headless --path . --script res://tests/integration/run_m18_locale_switch_soak.gd
...
run_checked "M14 Sakuya favor event" env XDG_DATA_HOME="$LOG_DIR/user-data" \
	"$GODOT_BIN" --headless --path . --script res://tests/integration/run_m14_sakuya_favor_event.gd
run_checked "M14 Sakuya missing-minute event" env XDG_DATA_HOME="$LOG_DIR/user-data" \
...
run_checked "M14 Youmu Archive farewell event" env XDG_DATA_HOME="$LOG_DIR/user-data" \
...
run_checked "M14 Tenshi Heaven Without Friction integration" env XDG_DATA_HOME="$LOG_DIR/user-data" \
